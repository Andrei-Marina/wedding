...
export const Contents: { [key: string]: Content } = {
  ru: {
    ...
    detailsSection: {
      ...
      presenceFormValue2: "К сожалению, нет",
      presenceFormValue3: "Сообщу позже",
      preferencesFormLabel: "Предпочтения:",
      drinksOption1: "Вино",
      drinksOption2: "Шампанское",
      drinksOption3: "Коньяк",
      drinksOption4: "Водка",
  ...
  ro: {
    ...
    detailsSection: {
      ...
      presenceFormValue2: "Din păcate, nu",
      presenceFormValue3: "Spun mai târziu",
      preferencesFormLabel: "Preferințe:",
      drinksOption1: "Vin",
      drinksOption2: "Vin spumant",
      drinksOption3: "Coniac",
      drinksOption4: "Vodka",
